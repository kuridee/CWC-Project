...
<div class="container-fluid">
		<div class="row setup">
			...
			<div class="col-sm-12">
				<p style="font-weight: bold; font-size: 50px;">TOR REQUEST</p>
				<br>
...
<div class="row">
	...
	<div class="col-sm-12 adjust">
				...
				<p id="formButton" style="font-weight: bold">TOR Request Details</p>
	<!-- Table of enrollment-->
...
$display = "SELECT * FROM Tor ORDER BY id DESC";
...

	{
		...
		<tr>
					...
					<td>
						...
						<a href="Tor_delete.php?id=<?php  echo $row["id"]?>">Done</a>
