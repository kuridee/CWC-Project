...
<div class="aform">
      ...
      <form method="Post" class=" form-inline" enctype="multipart/form-data">
        ...
        <p style="font-weight: bold;">REQUEST FOR GOOD MORAL</p>
        <h6 style="font-size: 12px;">Please fill up the required information below.</h6>
          ...
          <input type="" name="doc" class="ip" value="Good Moral" readonly><br>
          ...
          <button type="submit" class="btn btn-danger" name="submoral">Submit</button>
