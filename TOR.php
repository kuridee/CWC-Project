...
<div class="aform">
  		...
  		<form method="Post" class=" form-inline" enctype="multipart/form-data">
  			...
  			<p style="font-weight: bold;">REQUEST FOR TRANSCRIPT OF RECORDS</p>
          ...
          <input type="" name="lname" class="ip" required><br>
					...
					<input type="" name="doc" class="ip" value="TOR" readonly><br>
          ...
          <select name="mode" required>
            ...
            <option>Mluierlher</option>
					...
					<input type="" name="amount" value="300" class="ip" required><br>
          ...
          <input type="hidden" name="size" value="1000000">
					...
					<button type="submit" class="btn btn-danger" name="subtor">Submit</button>
