...
<div class="aform">
  		...
  		<form method="Post" class=" form-inline">
  			...
  			<p style="font-weight: bold;">REQUEST FOR GRADES</p>
          ...
          <input type="date" name="date" class="ip" required><br>
					...
					<input type="" name="grades" class="ip" value="Grades" readonly><br><br>
          ...
          <select name="year" required>
           ...
           <option></option>
            ...
            <option>2nd S.Y 2025-2026</option>
					...
					<button type="submit" class="btn btn-danger" name="btngrade">Submit</button>
