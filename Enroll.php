...
<div class="aform">
        ...
        <div style="height:38px; width: 270px; background-color: maroon; padding: 6px; padding-bottom: 10px;">
  			<p style="font-weight: bold; color: white;">APPLICATION FOR ENROLLMENT</p>
        </div><br>
          ...
          <input type="" name="lname" class="ip" required><br>
					...
					<input type="" name="address" class="ip" value="" required><br>

          <label>Date:</label><br>
          <input type="date" name="date" class="ip" value="" required><br><br>


					<label style="font-weight: bold;">Contact Details:</label><br>
					<label>Email</label><br>
					<input type="" name="email" class="ip" required><br>

					<label>Contact Number:</label><br>
					<input type="" name="contact" class="ip" required><br>


          <label>College Status:</label><br>
          ...
          <select name="semester" required>
            <option></option>
            <option>1st S.Y 2024-2025</option>
            <option>2nd S.Y 2024-2025</option>
             <option>1st S.Y 2025-2026</option>
            <option>2nd S.Y 2025-2026</option>
          </select><br>
          ...
          <select name="mode" required>
            ...
            <option>Mluierlher</option>
					...
					<input type="" name="amount" class="ip" required><br>
          ...
          <input type="hidden" name="size" value="1000000" required>
					...
					<button type="submit" class="btn btn-danger" name="btnenroll">Submit</button>
